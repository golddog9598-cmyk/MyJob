...
const releases = [
  {
    version: 'V0.0.12',
    date: '2026-07-16',
    summary: '修复 BOSS 页面有岗位但工作台获取结果为 0 的问题。',
    groups: [
      {
        title: 'BOSS 岗位获取',
        items: [
          '恢复以岗位详情链接为入口的解析方式，兼容页面卡片类名变化。',
          '岗位标题支持从详情链接文本回退读取。',
          '等待动态岗位列表渲染后再返回搜索结果。',
          '增加南宁城市代码，保持 BOSS 正确的单数 job 搜索路径。',
          '解码 BOSS 薪资私有字体，按岗位卡片实际显示保存薪资或面议。',
        ],
      },
    ],
  },
  {
    version: 'V0.0.10',
    date: '2026-07-16',
    summary: '增加用户侧 JD 智能定制和四平台独立投递限额。',
    groups: [
      {
        title: 'JD 定制与自动化边界',
        items: [
          '四个平台分别配置和统计每日投递上限，每个平台最多 50。',
          '浏览器扩展从岗位详情页读取完整 JD，并只写入用户侧 IndexedDB。',
          '仅优化个人简介、工作经历、项目经历、专业技能和自我评价。',
          '提供低、中、高、极高四档事实约束强度。',
          '新增事实和量化结果必须由用户确认后才能应用。',
          '提供修改对比、逐项应用、批量应用和相同输入本地缓存。',
        ],
      },
    ],
  },
  {
    version: 'V0.0.9',
    date: '2026-07-16',
    summary: '招聘平台操作和数据迁移到用户浏览器侧。',
    groups: [
      {
        title: '用户侧平台架构',
        items: [
          '新增 Chrome 与 Edge 共用的 Manifest V3 平台桥接扩展。',
          '岗位、投递、会话、求职计划和平台统计改存浏览器 IndexedDB。',
          'FastAPI 不再提供招聘平台操作和数据接口。',
          '已登录平台不会重复打开登录窗口，登出会清除全部平台会话。',
          '停止按钮会关闭所有招聘平台窗口。',
          '工作台增加全部平台汇总和所选平台明细。',
          '移除登录心跳文案和简历标题右侧的新简历标记。',
        ],
      },
    ],
  },
  {
    version: 'V0.0.8',
    date: '2026-07-15',
    summary: '用四平台状态卡和自动心跳替代手动检查登录。',
    groups: [
      {
        title: '登录状态',
        items: [
          '顶部新增四个平台登录状态卡，已登录平台凸出高亮并显示绿色状态点。',
          '未登录平台置灰显示，点击状态卡即可切换当前招聘平台。',
          '启动浏览器调整为启动登录，并移除前端手动检查登录入口。',
          '每 15 秒执行一次轻量四平台心跳，只在登录状态变化时广播。',
          '完善日间、夜间和移动端状态卡布局。',
        ],
      },
    ],
  },
  {
    version: 'V0.0.7',
    date: '2026-07-15',
    summary: '在统一浏览器和岗位模型中接入四个招聘平台。',
    groups: [
      {
        title: '多平台求职',
        items: [
          '新增智联招聘、猎聘和前程无忧登录、搜索、筛选、岗位入库与单岗位投递。',
          '四个平台复用一个可见浏览器上下文，并按平台页面和域名隔离登录态。',
          '岗位中心、统一 API 和 MyJob CLI 增加平台选择、来源展示与平台筛选。',
          '登录检测必须出现明确账号证据，验证码和安全验证保留人工处理。',
          'BOSS 直聘继续负责消息同步和招聘者活跃度筛选。',
        ],
      },
    ],
  },
    ...
    groups: [
      {
        title: '简历中心主题',
        items: [
          '修复日间主题选择器未命中简历编辑器控件的问题。',
          '统一输入框、照片上传、字号与行距设置、经历卡片和缩放控件的日间配色。',
          '补齐简历模板与定制简历弹窗的日间主题，同时保持夜间模式不变。',
        ],
      },
    ],
  },
